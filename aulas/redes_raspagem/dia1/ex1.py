"""  Crie um servidor TCP usando o módulo socketserver
que já vem embutido com o Python. Nosso servidor TCP deverá:
...
if __name__ == "__main__":
    # usando with nosso TCPServer vai arrumar a casa quando encerrado
